...
1. Double-click the HEIC file. If it opens in the Photos app, you're done.
2. If it doesn't open, Photos will usually show a link to get the HEIF Image Extensions. Click it, or open the **Microsoft Store** and search for "HEIF Image Extensions" (the free package published by Microsoft).
3. Click **Get / Install**, then reopen your photo.
...
3. If the image still won't render, you may also need **HEVC Video Extensions** ($0.99) because many iPhone photos use HEVC compression inside the HEIC container.
4. Reopen the file with the **Photos** app.

If you'd rather not pay for a codec or install anything, a free online converter does the job: drop your files into our [HEIC to JPG converter](/heic-to-jpg) and download standard JPGs that Windows 10 opens natively. For dozens or hundreds of photos at once, use the [batch converter](/batch-convert).
...
If you're on an older macOS version (Sierra or earlier), Preview won't recognize HEIC — use the browser-based method below, or see our full guide to [converting HEIC to JPG on Mac](/how-to-convert-heic-to-jpg-mac).
...
1. Go to [openmyheic.com](/).
2. Drag and drop your HEIC files onto the page.
3. See your photos instantly — and download them as JPG, PNG, or other formats if you want to keep a compatible copy.
...
|-----|--------------|------------|
| Photoshop | Yes (with system codecs) | Convert to [JPG](/heic-to-jpg) or [PNG](/heic-to-png) first on older versions |
...
If you keep running into HEIC files, you can tell your iPhone to capture photos as JPG instead: go to **Settings → Camera → Formats** and choose **Most Compatible**. Our guide on [converting HEIC to JPG on iPhone](/blog/convert-heic-to-jpg-on-iphone/) covers this in detail, including how to transfer photos so they convert automatically.
...
There's a small, usually invisible loss because JPG uses different compression. For everyday photos, sharing, and printing, you won't notice a difference. If you need lossless output, convert to [PNG](/heic-to-png) instead.

### How do I open a lot of HEIC files at once?

Use the [batch HEIC converter](/batch-convert) — drop in an entire folder of photos and download them all as JPGs in a single ZIP.
