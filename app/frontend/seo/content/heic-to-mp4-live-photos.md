...
If what you actually need is a still image in a compatible format, you want [HEIC to JPG](/heic-to-jpg) instead.
...
3. Scroll down and tap **Save as Video**.
...
1. In Photos, go to **Albums → Media Types → Live Photos**.
2. Tap **Select** and choose the ones you want.
3. Tap **Share → Save as Video**.
...
1. Right-click the Live Photo → **Export → Export Unmodified Original**.
2. You'll get two files: the HEIC still **and a .MOV file** with the motion.
3. The .MOV plays everywhere; convert it to MP4 with QuickTime (File → Export As) if a service specifically requires .mp4.
...
1. Import your photos (Photos app or File Explorer).
2. Sort the folder by name — each Live Photo has a matching .MOV.
3. Use the .MOV directly, or convert it to MP4 with any video tool (VLC does it free: Media → Convert/Save).
...
- Convert single photos with the free in-browser [HEIC to JPG converter](/heic-to-jpg) — nothing gets uploaded, everything runs locally.
- Convert whole folders with the [batch converter](/batch-convert).
- Need lossless? Use [HEIC to PNG](/heic-to-png).

## FAQ

### Can I convert a normal (non-Live) HEIC photo to MP4?

Technically some tools will wrap a still image into a video track, but the result is a static one-frame clip — rarely what anyone wants. For normal photos, convert to [JPG](/heic-to-jpg) or [PNG](/heic-to-png).
...
Apple's high-efficiency photo format, used since iOS 11. Full explanation: [What is a HEIC file?](/what-is-heic)
